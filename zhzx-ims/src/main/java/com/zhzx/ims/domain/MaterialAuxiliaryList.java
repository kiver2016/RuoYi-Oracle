...
/**
 * 送货清单辅材对象 material_auxiliary_list
 * 
 * @author ruoyi
 * @date 2019-11-27
 */
public class MaterialAuxiliaryList extends BaseEntity
{
    private static final long serialVersionUID = 1L;

    /** 主键 */
    private Long materialAuxiliaryId;
    ...
    public void setMaterialAuxiliaryId(Long materialAuxiliaryId) 
    {
        this.materialAuxiliaryId = materialAuxiliaryId;
    }

    public Long getMaterialAuxiliaryId() 
    {
        return materialAuxiliaryId;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            .append("materialAuxiliaryId", getMaterialAuxiliaryId())
